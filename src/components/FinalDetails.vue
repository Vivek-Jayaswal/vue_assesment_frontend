<<template>
    <div class="">
        <div class="flex justify-between items-center sm:px-10 py-5">
            <div>
        ...
        <div class="w-full flex sm:px-10 justify-end items-end">
        ...
        <div class="flex justify-end gap-10 py-10 sm:px-10">
    ...
    export default {
        ...
        methods: {
            ...
            async handlefinalStep() {
                console.log("click");
                if (!this.userData || !this.companyData || this.transactionData.length === 0) {
                ...
                try {
                    ...
                    if (response.status === 200) {
                        this.$emit("invoiceCreated", response.data);
